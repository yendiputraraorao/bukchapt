...
class Registrasi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'start' => $start,
            'konten' => 'registrasi/anggota_list',
            'judul' => 'Data Anggota',
        );
    ...
    public function read($id) 
    {
		...
		'konten' => 'registrasi/anggota_read',
        'judul' => 'Data Anggota',
	    );
            $this->load->view('v_index', $data);
        } else {
    ...
    public function create() 
    {
        ...
        'konten' => 'registrasi/anggota_form',
        'judul' => 'Data Anggota',
	);
        $this->load->view('v_index', $data);
    }
    ...
    public function create_action() 
    {
		...
		'foto_anggota' => $dfile,
            ...
            redirect(site_url('registrasi/berhasil'));
        }
    }
    public function berhasil(){
		
		$data =array('konten' => 'registrasi/berhasil');
		$this->load->view('v_index', $data);
